  ...
  return (
    ...
    >
      {/*
        ...
        muestra directamente sobre el fondo oscuro del sidebar (sin
        recuadro blanco) y a gran tamano.
      */}
      <div style={{ display: 'flex', justifyContent: 'center', padding: '4px 0' }}>
        {settings?.logoDataUrl ? (
          <img
            ...
            alt={settings.name}
            style={{ width: '100%', maxWidth: 216, height: 'auto', objectFit: 'contain', borderRadius: 10 }}
          />
        ) : (
          <LoadingLogo size={64} />
        )}
